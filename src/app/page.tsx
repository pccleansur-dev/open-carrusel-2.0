                ...
                <div className="rounded-2xl border border-border bg-surface">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-7">
                    {calendarDays.map((day) => {
                      ...
                      const hasScheduledPosts = items.length > 0;
                      ...
                      return (
                        <div
                          ...
                          className={`min-h-36 border-b border-r border-border p-2 last:border-r-0 sm:[&:nth-child(7n)]:border-r-0 ${
                            hasScheduledPosts
                              ? "bg-violet-500/[0.08] shadow-[inset_0_0_0_1px_rgba(139,92,246,0.22)]"
                              : isCurrentMonth
                                ? "bg-surface"
                                : "bg-muted/20"
                          } ${
                            hasScheduledPosts && !isCurrentMonth
                              ? "bg-violet-500/[0.05]"
                              : ""
                          }`}
                        >
                          <div className="mb-2 flex items-center justify-between">
                            ...
                            {hasScheduledPosts ? (
                              <span className="rounded-full bg-violet-500/15 px-2 py-0.5 text-[10px] font-medium text-violet-700">
